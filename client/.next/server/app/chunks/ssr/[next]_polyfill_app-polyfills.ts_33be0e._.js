(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/ssr/[next]_polyfill_app-polyfills.ts_33be0e._.js", {

"[next]/polyfill/async-local-storage.js (ecmascript, ssr)": (({ r: __turbopack_require__, x: __turbopack_external_require__, f: __turbopack_require_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, j: __turbopack_cjs__, g: global, __dirname }) => (() => {
...
;
;
globalThis.__NEXT_USE_UNDICI = true;

}.call(this) }),
}]);

//# sourceMappingURL=[next]_polyfill_app-polyfills.ts_33be0e._.js.map